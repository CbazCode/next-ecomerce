        ...
        <div className="edit_user my-3">
            ...
            <div className="col-md-4 mx-auto my-4">
                ...
                <div className="form-group">
                    ...
                    <input type="text" id="name" defaultValue={editUser.name} disabled style={{padding:'0.3rem 1rem'}}/>
                </div>

                <div className="form-group">
                    <label htmlFor="email" className="d-block">Email</label>
                    <input type="text" id="email" defaultValue={editUser.email} disabled style={{padding:'0.3rem 1rem'}}/>
                </div>
